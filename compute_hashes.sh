...
URL="https://github.com/Oxen-AI/Oxen/releases/download/v$VERSION/oxen-mac-13.0-$VERSION.tar.gz"
echo "Downloading $URL"
wget -q $URL
shasum -a 256 oxen-mac-13.0-$VERSION.tar.gz
...
URL="https://github.com/Oxen-AI/Oxen/releases/download/v$VERSION/oxen-server-mac-13.0-$VERSION.tar.gz"
echo "Downloading $URL"
wget -q $URL
shasum -a 256 oxen-server-mac-13.0-$VERSION.tar.gz
